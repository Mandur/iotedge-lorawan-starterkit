...
namespace XunitRetryHelper
{
    ...
    public class RetryTheoryTestDiscoverer(IMessageSink diagnosticMessageSink) : IXunitTestCaseDiscoverer
    {
        private readonly IMessageSink diagnosticMessageSink = diagnosticMessageSink;
